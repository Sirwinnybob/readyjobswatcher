...
content = re.sub(r'def run_dark_mode_conversion\(.*?Started PDF dark mode conversion for all files\{force_msg\} in background thread"\)', new_run_dark_mode, content, flags=re.DOTALL)
