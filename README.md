...
*   **Comprehensive Logging:** Implements detailed, component-specific logging (main operations, backups, CNC scans, and bad part detection) for easy troubleshooting and auditing, including automatic rotation/clearing of logs older than 7 days.
...
3.  **Bad Parts Workflow:**
    ...
    *   The application detects this and logs it to `Desktop\Bad Parts Log.txt`.
